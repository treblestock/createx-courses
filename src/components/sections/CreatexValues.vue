...
<template>
  <section class="createx-values">
    <div class="createx-values__label title_label">We always stand for</div>
    <div class="createx-values__title title">Our core values</div>
    <ul class="createx-values__items">
